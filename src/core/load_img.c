...
/*   Updated: 2024/03/27 01:19:19 by liurne           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	load_map_img(t_data *sl)
{
	...
	load_img(sl, "texture/border_river_h.xpm", &(sl->map.tex[13]));
	load_img(sl, "texture/border_river_v.xpm", &(sl->map.tex[14]));
	load_img(sl, "texture/border_corner_ld.xpm", &(sl->map.tex[15]));
	load_img(sl, "texture/border_corner_lu.xpm", &(sl->map.tex[16]));
	load_img(sl, "texture/border_corner_rd.xpm", &(sl->map.tex[17]));
	load_img(sl, "texture/border_corner_ru.xpm", &(sl->map.tex[18]));
	load_img(sl, "texture/border_empty.xpm", &(sl->map.tex[19]));
	load_img(sl, "texture/border_cross_dlur.xpm", &(sl->map.tex[20]));
	load_img(sl, "texture/border_cross_drul.xpm", &(sl->map.tex[21]));
	load_img(sl, "texture/border_river_cross_dl.xpm", &(sl->map.tex[22]));
	load_img(sl, "texture/border_river_cross_dr.xpm", &(sl->map.tex[23]));
	load_img(sl, "texture/border_river_cross_ul.xpm", &(sl->map.tex[24]));
	load_img(sl, "texture/border_river_cross_ur.xpm", &(sl->map.tex[25]));
	load_img(sl, "texture/border_river_end_d.xpm", &(sl->map.tex[26]));
	load_img(sl, "texture/border_river_end_l.xpm", &(sl->map.tex[27]));
	load_img(sl, "texture/border_river_end_r.xpm", &(sl->map.tex[28]));
	load_img(sl, "texture/border_river_end_u.xpm", &(sl->map.tex[29]));
	...
	load_img(sl, "texture/border_turn_dl.xpm", &(sl->map.tex[34]));
	load_img(sl, "texture/border_turn_dr.xpm", &(sl->map.tex[35]));
	load_img(sl, "texture/border_turn_ul.xpm", &(sl->map.tex[36]));
	load_img(sl, "texture/border_turn_ur.xpm", &(sl->map.tex[37]));
	load_img(sl, "texture/border_river_cross_d.xpm", &(sl->map.tex[38]));
	load_img(sl, "texture/border_river_cross_u.xpm", &(sl->map.tex[39]));
	load_img(sl, "texture/border_river_cross_l.xpm", &(sl->map.tex[40]));
	load_img(sl, "texture/border_river_cross_r.xpm", &(sl->map.tex[41]));
	load_img(sl, "texture/border_river_cross_dul.xpm", &(sl->map.tex[42]));
	load_img(sl, "texture/border_river_cross_dur.xpm", &(sl->map.tex[43]));
	load_img(sl, "texture/border_river_cross_ldl.xpm", &(sl->map.tex[44]));
	load_img(sl, "texture/border_river_cross_lul.xpm", &(sl->map.tex[45]));
	load_img(sl, "texture/border_river_cross_rdr.xpm", &(sl->map.tex[46]));
	load_img(sl, "texture/border_river_cross_rur.xpm", &(sl->map.tex[47]));
	load_img(sl, "texture/border_river_cross_udl.xpm", &(sl->map.tex[48]));
	load_img(sl, "texture/border_river_cross_udr.xpm", &(sl->map.tex[49]));
	...
	load_img(sl, "texture/end_full.xpm", &(sl->map.tex[53]));//a clear
	load_img(sl, "texture/end_full.xpm", &(sl->map.tex[54]));
	load_img(sl, "texture/collectible_empty.xpm", &(sl->map.tex[55]));
	load_img(sl, "texture/collectible_empty.xpm", &(sl->map.tex[56]));//a clear
}
