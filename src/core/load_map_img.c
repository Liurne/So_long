...
{
	load_img(sl, "asset/texture/map/border_d.xpm", &(sl->map.tex[9]));
	load_img(sl, "asset/texture/map/border_u.xpm", &(sl->map.tex[10]));
	load_img(sl, "asset/texture/map/border_l.xpm", &(sl->map.tex[11]));
	load_img(sl, "asset/texture/map/border_r.xpm", &(sl->map.tex[12]));
	load_img(sl, "asset/texture/map/border_dr.xpm", &(sl->map.tex[13]));
	load_img(sl, "asset/texture/map/border_dl.xpm", &(sl->map.tex[14]));
	load_img(sl, "asset/texture/map/border_ul.xpm", &(sl->map.tex[15]));
	load_img(sl, "asset/texture/map/border_ur.xpm", &(sl->map.tex[16]));
	load_img(sl, "asset/texture/map/border_river_h.xpm", &(sl->map.tex[17]));
	load_img(sl, "asset/texture/map/border_river_v.xpm", &(sl->map.tex[18]));
	load_img(sl, "asset/texture/map/border_corner_ld.xpm", &(sl->map.tex[19]));
	load_img(sl, "asset/texture/map/border_corner_lu.xpm", &(sl->map.tex[20]));
	load_img(sl, "asset/texture/map/border_corner_rd.xpm", &(sl->map.tex[21]));
	load_img(sl, "asset/texture/map/border_corner_ru.xpm", &(sl->map.tex[22]));
...
{
	load_img(sl, "asset/texture/map/border_empty.xpm", &(sl->map.tex[0]));
	load_img(sl, "asset/texture/map/grass_empty.xpm", &(sl->map.tex[1]));
	load_img(sl, "asset/texture/map/grass_alt.xpm", &(sl->map.tex[2]));
	load_img(sl, "asset/texture/map/grass_alt_2.xpm", &(sl->map.tex[3]));
	load_img(sl, "asset/texture/map/stone.xpm", &(sl->map.tex[4]));
	load_img(sl, "asset/texture/map/stone_alt.xpm", &(sl->map.tex[5]));
	load_img(sl, "asset/texture/map/end_closed.xpm", &(sl->map.tex[6]));
	load_img(sl, "asset/texture/map/end_open.xpm", &(sl->map.tex[7]));
	load_img(sl, "asset/texture/map/collectible.xpm", &(sl->map.tex[8]));
}
